enum { SUBURBAN_MACRO, URBAN_MACRO, URBAN_MICRO };
enum { NONE , PALARIZED , LOS , URBAN_CANYON };

struct scmpar;
typedef struct scmpar scmpar;
struct scmpar {
	int Numfan;
	int NumBsElements; 
	int NumMsElements;
	...
	int SampleDensity;
	int NumTimeSamples;
	bool UniformTimeSampling;
	int BsUrbanMacroAs;
	int NumPaths;
	int NumSubPathsPerPath;
	bool IntraClusterDsUsed;
	bool FixedPdpUsed;
	bool FixedAnglesUsed;
	bool DriftDelaysAngles;
	bool DriftShadowFading;
	bool DriftFrequency;
	float CenterFrequency;
	int ScmOptions;
	int DelaySamplingInterval;
	bool PathLossModeUsed;
	bool ShadowingModelUsed;
	char* PathLossModel;
	bool AlternativePathloss;
	bool AnsiC_core;
	int LookUpTable;
	int RandomSeed;
};
...
scmpar=struct(  'Numfan',1,...
                'NumBsElements',4,...                   
                'NumMsElements',4,...                   
                'Scenario','urban_macro',...
                'SampleDensity', 90,...                  % in samples/half-wavelength
                'NumTimeSamples',10,...                
                ...
                'DelaySamplingInterval',6.5104e-008,...        
